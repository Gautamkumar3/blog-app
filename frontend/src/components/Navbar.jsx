        ...
        <>
            <Flex justifyContent="space-between" fontSize="xl" h={"80px"} align="center" bg="#604d9e" p={5} color="white">
                ...
                <Flex gap={5}>
                    ...
                    }} _hover={{ bg: "lightblue" }} variant='outline'>
                        {token ? "Logout" : "Login"}
                    </Button>
                    {token ? <Avatar size='sm' name='user' src='https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png' /> : "" }
